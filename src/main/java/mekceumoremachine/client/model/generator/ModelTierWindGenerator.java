package mekceumoremachine.client.model.generator;
...
public class ModelTierWindGenerator extends ModelBase {
    ...
    public void renderHead(float size) {
        head.render(size);
    }
