...
public class WirelessChargingEnergyVisualRenderer {
    ...
    private static final double SHRINK_PIVOT_Y = 2.796875D;
    ...
    public static void render(TileEntityWirelessChargingEnergy tile, float scale, double cameraX, double cameraY, double cameraZ) {
        render(tile, scale, cameraX, cameraY, cameraZ, cameraY);
    }

    public static void render(TileEntityWirelessChargingEnergy tile, float scale, double cameraX, double cameraY, double cameraZ, double cameraEyeY) {
    ...
    public static void render(TileEntityWirelessChargingEnergy tile, float scale, double cameraX, double cameraY, double cameraZ, boolean renderTop, boolean renderBottom) {
        int radius = tile.getRang();
