...
public class RenderTierWindGeneratorItem extends MekanismItemStackRenderer {
    ...
    protected void renderBlockSpecific(@Nonnull ItemStack stack, ItemCameraTransforms.TransformType transformType) {
        ...
        MekanismRenderer.bindTexture(MekanismUtils.getResource(MEKCeuMoreMachine.MODID, ResourceType.RENDER, "WindGenerator_" + tier.getBaseTier().getSimpleName() + ".png"));
