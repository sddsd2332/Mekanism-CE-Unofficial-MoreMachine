...
public class RenderWirelessChargingEnerygItem extends MekanismItemStackRenderer {

    public static ItemLayerWrapper model;

    private static ModelWirelessChargingEnergy cube = new ModelWirelessChargingEnergy();
    ...
    protected void renderBlockSpecific(@Nonnull ItemStack stack, ItemCameraTransforms.TransformType transformType) {
        ...
        MekanismRenderer.bindTexture(MekanismUtils.getResource(MEKCeuMoreMachine.MODID, MekanismUtils.ResourceType.RENDER, "Wireless_Energy_" + tier.getBaseTier().getSimpleName() + ".png"));
        cube.renderModelTier(0.034F);
        MekanismRenderer.bindTexture(MekanismUtils.getResource(MEKCeuMoreMachine.MODID, MekanismUtils.ResourceType.RENDER, "Wireless_Energy.png"));
