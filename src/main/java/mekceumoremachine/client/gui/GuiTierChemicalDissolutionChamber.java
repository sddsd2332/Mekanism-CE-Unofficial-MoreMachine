...
public class GuiTierChemicalDissolutionChamber extends GuiConfigurableTile<TileEntityTierChemicalDissolutionChamber, ContainerTierChemicalDissolutionChamber> {
    ...
    protected void addGuiElements() {
        ...
        addButton(new GuiGasGauge(this, tileEntity.injectTank, GuiGasGauge.Type.SMALL, 7, 32).withColor(GuiGasGauge.GaugeColor.ORANGE));
