...
public class BlockReplicatorItemStack extends BlockTierMachine {

    public BlockReplicatorItemStack() {
        super();
    }
    ...
    public TileEntity getTileEntity() {
        return new TileEntityReplicatorItemStack();
    }

    @Override
    public Block getMachineBlock() {
        return MEKCeuMoreMachineBlocks.ReplicatorItemStack;
    }
}
