...
public class BlockReplicatorFluidStack extends BlockTierMachine {

    public BlockReplicatorFluidStack() {
        super();
    }
    ...
    public TileEntity getTileEntity() {
        return new TileEntityReplicatorFluidStack();
    }

    @Override
    public Block getMachineBlock() {
        return MEKCeuMoreMachineBlocks.ReplicatorFluidStack;
    }
}
