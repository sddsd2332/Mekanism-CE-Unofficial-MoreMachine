...
public class BlockVoidMineralGenerator extends BlockTierMachine {

    public BlockVoidMineralGenerator() {
        super();
    }
    ...
    public TileEntity getTileEntity() {
        return new TileEntityVoidMineralGenerator();
    }

    @Override
    public Block getMachineBlock() {
        return MEKCeuMoreMachineBlocks.VoidMineralGenerator;
    }
}
