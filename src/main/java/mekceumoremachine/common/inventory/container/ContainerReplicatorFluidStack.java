...
public class ContainerReplicatorFluidStack extends ContainerMekanism<TileEntityReplicatorFluidStack> {
    ...
    protected void addSlots() {
        addSlotToContainer(new SlotEnergy.SlotDischarge(tileEntity, 0, 155, 14));
    }
}
