...
public class ContainerReplicatorItemStack extends ContainerMekanism<TileEntityReplicatorItemStack> {
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int slotID) {
        ...
        if (currentSlot != null && currentSlot.getHasStack()) {
            ...
            } else if (TileEntityReplicatorItemStack.isInRecipe(slotStack)) {
                if (slotID != 0) {
    ...
    protected void addSlots() {
        ...
        addSlotToContainer(new SlotEnergy.SlotDischarge(tileEntity, 1, 141, 35));
