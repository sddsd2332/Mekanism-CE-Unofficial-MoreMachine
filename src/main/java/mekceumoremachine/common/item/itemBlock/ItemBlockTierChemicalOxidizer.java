...
public class ItemBlockTierChemicalOxidizer extends ItemBlockMekceuMoreMachine implements ISpecialElectricItem, IEnergyContainerItem, ISustainedInventory, ISecurityItem , IItemTipName {
    ...
    public double getMachineStorage() {
        return BlockStateMachine.MachineType.CHEMICAL_OXIDIZER.getStorage();
    }
