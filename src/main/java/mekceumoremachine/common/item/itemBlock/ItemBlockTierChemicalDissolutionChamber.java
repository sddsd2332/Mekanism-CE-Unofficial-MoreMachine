...
public class ItemBlockTierChemicalDissolutionChamber extends ItemBlockMekceuMoreMachine implements ISpecialElectricItem, IEnergyContainerItem, ISustainedInventory, ISecurityItem , IItemTipName {
