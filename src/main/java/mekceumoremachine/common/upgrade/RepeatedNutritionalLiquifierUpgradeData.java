...
public class RepeatedNutritionalLiquifierUpgradeData extends LargeMachineUpgradeData {
    ...
    public RepeatedNutritionalLiquifierUpgradeData(@Nonnull BaseTier upgradeTier, @Nonnull TileEntityTierNutritionalLiquifier source) {
