...
public class FirstChemicalOxidizerUpgradeData extends LargeMachineUpgradeData {
    ...
    public FirstChemicalOxidizerUpgradeData(@Nonnull BaseTier upgradeTier, @Nonnull TileEntityContainerBlock source,
        ...
        unmappedGasSlot = copySlot(source, 1);
