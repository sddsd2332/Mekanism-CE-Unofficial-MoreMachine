...
public class TileEntityTierChemicalOxidizer extends TileEntityMachine implements ISustainedData, ITankManager, ISpecialConfigData, IComparatorSupport, ISideConfiguration, INeedRepeatTierUpgrade<MachineTier>, ITierSorting, IRecipeLookupHandler<OxidationRecipe>, TierProcessInputSorter.Context {
    ...
    protected boolean supportsAsyncIdleSkipping() {
        Class<?> type = getClass();
        return type == TileEntityTierChemicalOxidizer.class || type == TileEntityTierChemicalOxidizerBasic.class ||
              type == TileEntityTierChemicalOxidizerAdvanced.class || type == TileEntityTierChemicalOxidizerElite.class ||
              type == TileEntityTierChemicalOxidizerUltimate.class;
    }
